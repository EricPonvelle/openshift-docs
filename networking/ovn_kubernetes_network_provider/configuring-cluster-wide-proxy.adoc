...
ifdef::openshift-dedicated[]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/openshift_dedicated_clusters_on_aws/#osd-create-aws-cluster-ccs_osd-creating-a-cluster-on-aws[Creating a cluster on AWS]
...
include::includes/configuring-a-proxy-after-installation-ocm.adoc[leveloffset=+1]
