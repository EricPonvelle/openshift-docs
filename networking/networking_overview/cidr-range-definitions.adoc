...
include::includes/machine-cidr-description.adoc[leveloffset=+1]
...
include::includes/service-cidr-description.adoc[leveloffset=+1]

include::includes/pod-cidr-description.adoc[leveloffset=+1]
...
include::includes/host-prefix-description.adoc[leveloffset=+1]
