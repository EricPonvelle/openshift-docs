...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/ingress_and_load_balancing/#nw-route-specific-annotations[Route-specific annotations]