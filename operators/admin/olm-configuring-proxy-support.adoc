...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/ovn-kubernetes_network_plugin/#configuring-cluster-wide-proxy[Configuring a cluster-wide proxy]
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
