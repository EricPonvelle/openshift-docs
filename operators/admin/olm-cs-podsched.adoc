...
* xref:olm-software-catalog-arch-operatorhub-crd_olm-understanding-software-catalog[OperatorHub custom resource]
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/nodes/#nodes-scheduler-node-selectors[Placing pods on specific nodes using node selectors]
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/nodes/#admin-guide-priority-preemption-priority-class_nodes-pods-priority[Pod priority classes]
