...
* You have installed the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/cli_tools/#cli-opm-install[`opm` CLI].
...
// TODO-HCP remove conditions for HCP after cli_tools book is migrated
ifndef::openshift-rosa-hcp[]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/cli_tools/#cli-opm-ref[`opm` CLI reference]
endif::openshift-rosa-hcp[]
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/authentication_and_authorization/#understanding-and-managing-pod-security-admission[Understanding and managing pod security admission]
