...
ifdef::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
** xref:olm-installing-operators-from-software-catalog_olm-adding-operators-to-a-cluster[Install an Operator from the software catalog].
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
...
* xref:olm-what-operators-are[What are Operators?]
