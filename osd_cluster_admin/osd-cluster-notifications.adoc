...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/introduction_to_openshift_dedicated/#notifications_policy-process-security[Customer responsibilities: Review and action cluster notifications]
...
* Ensure that your firewall is configured according to the documented prerequisites: link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/planning_your_environment/#osd-aws-privatelink-firewall-prerequisites_aws-ccs[AWS firewall prerequisites]