...
include::../includes/enable-private-cluster-new.adoc[leveloffset=+1]

include::../includes/enable-private-cluster-existing.adoc[leveloffset=+1]

include::../includes/enable-public-cluster.adoc[leveloffset=+1]
