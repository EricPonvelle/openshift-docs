...
* xref:osd-nodes-about-autoscaling-nodes[About autoscaling]
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/introduction_to_openshift_dedicated/#gcp-regions-availability-zones_osd-service-definition[{gcp-full} regions and availability zones]