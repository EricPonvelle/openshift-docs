...
* For more information on storage, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/storage/#index[{product-title} storage].
* For more information on authentication, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/authentication_and_authorization/#index[{product-title} authentication].
* For more information on Operator Lifecycle Manager (OLM), see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/operators/#olm-understanding-olm[OLM].
// Topic not included in the OSD/ROSA docs
ifndef::openshift-dedicated,openshift-rosa[]
...
include::includes/architecture-about-cgroup-v2.adoc[leveloffset=+1]
