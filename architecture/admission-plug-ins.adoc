...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/nodes/#admin-guide-priority-preemption-names_nodes-pods-priority[Pod priority names]
