...
ifdef::openshift-dedicated[]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/upgrading/#osd-upgrades[{product-title} upgrade documentation]
...
* xref:showing-data-collected-from-the-cluster_showing-data-collected-by-remote-health-monitoring[Showing data collected by Telemetry]
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/monitoring/#about-ocp-monitoring[About {product-title} monitoring]
