...
If you have enabled remote health reporting, xref:using-insights-to-identify-issues-with-your-cluster[Using {red-hat-lightspeed} to identify issues with your cluster]. You can optionally disable remote health reporting.
