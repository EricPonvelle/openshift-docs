...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/operators/#olm-cs-health_olm-understanding-olm[Catalog health requirements]
...
// TODO: Add this xref when the Operators book is added to ROSA HCP.
ifndef::openshift-rosa-hcp[]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/operators/#olm-catalogsource_olm-understanding-olm[Operator Lifecycle Manager concepts and resources -> Catalog source]
endif::openshift-rosa-hcp[]
