...
include::../../includes/nodes-pods-autoscaling-custom-rn-2181.adoc[leveloffset=+1]

include::../../includes/nodes-pods-autoscaling-custom-rn-2172-2.adoc[leveloffset=+1]

include::../../includes/nodes-pods-autoscaling-custom-rn-2172.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* xref:nodes-cma-autoscaling-keda-controller-edit_nodes-cma-autoscaling-custom-install[Editing the Keda Controller CR]
...
include::../../includes/nodes-pods-autoscaling-custom-rn-2151-4.adoc[leveloffset=+1]
...
For more information, see xref:nodes-cma-autoscaling-custom-trigger-cron_nodes-cma-autoscaling-custom-trigger[Understanding the Cron trigger].
...
For more information, see xref:nodes-cma-autoscaling-custom-ca_nodes-cma-autoscaling-custom[Custom CA certificates for the Custom Metrics Autoscaler].
