...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/authentication_and_authorization/#understanding-service-accounts[Understanding and creating service accounts]
* xref:nodes-pods-secrets[Providing sensitive data to pods].
