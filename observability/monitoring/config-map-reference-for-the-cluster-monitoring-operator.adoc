...
For more information about supported configurations, see xref:maintenance-and-support-for-monitoring[Maintenance and support for monitoring].
...
|userWorkload|*xref:userworkloadconfig[UserWorkloadConfig]|`UserWorkload` defines settings for the monitoring of user-defined projects.
