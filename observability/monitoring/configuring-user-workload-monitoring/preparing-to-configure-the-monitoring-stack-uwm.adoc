...
Only the parameters and fields listed in the xref:cluster-monitoring-operator-configuration-reference[Config map reference for the {cmo-full}] are supported for configuration.
...
include::../includes/monitoring-configurable-monitoring-components.adoc[leveloffset=+1,tags=**;!CPM;UWM]
...
include::../includes/monitoring-enabling-alert-routing-for-user-defined-projects.adoc[leveloffset=+1]
...
include::../includes/monitoring-enabling-a-separate-alertmanager-instance-for-user-defined-alert-routing.adoc[leveloffset=+2]

include::../includes/monitoring-granting-users-permission-to-configure-alert-routing-for-user-defined-projects.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* xref:configuring-alert-notifications_configuring-alerts-and-notifications-uwm[Configuring alert notifications]
