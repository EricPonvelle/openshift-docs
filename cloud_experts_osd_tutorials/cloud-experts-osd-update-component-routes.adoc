...
include::includes/cloud-experts-osd-update-component-routes-environment-setup.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-find-current-component-routes.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-create-tls-certificates.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-add-certificates-as-secrets.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-find-lb-hostname.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-add-component-routes-to-dns.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-tls-using-ocm-cli.adoc[leveloffset=+1]
include::includes/cloud-experts-osd-update-component-routes-reset-component-routes-to-default.adoc[leveloffset=+1]