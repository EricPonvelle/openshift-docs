...
+
For more information, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/builds_using_buildconfig/#understanding-image-builds[Understanding image builds].
...
For more information, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html-single/jenkins/#images-other-jenkins[Configuring Jenkins images].
