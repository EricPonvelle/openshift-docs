...
include::../includes/distr-tracing-assembly-tip-for-jaeger-replacements.adoc[]

include::../includes/distr-tracing-tempo-key-concepts-in-distributed-tracing.adoc[leveloffset=+2]

include::../includes/distr-tracing-tempo-architecture.adoc[leveloffset=+2]

include::../includes/distr-tracing-tempo-features.adoc[leveloffset=+2]
