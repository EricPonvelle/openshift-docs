...
[id="cloud-experts-getting-start-detailed-cli-deployment-workflow_{context}"]
= Deployment workflow
...
If this is the _first time_ you are deploying {product-title} in this account and you have _not_ yet created the account roles, then create the account-wide roles and policies, including Operator policies.
...
----
+
You can also see the contents in the xref:../../../rosa_architecture/rosa-sts-about-iam-resources.adoc#rosa-sts-account-wide-roles-and-policies-creation-methods_rosa-sts-about-iam-resources[About IAM resources for {product-title} clusters] documentation.
...
----
+
See the xref:../../../rosa_install_access_delete_clusters/rosa-sts-interactive-mode-reference.adoc#rosa-sts-interactive-mode-reference[{product-title} documentation] for a description of the fields.
